"""Utility methods for common functionalities of neural networks."""
import numpy as np
import torch
import torch.nn as nn


def soft_argmax2d(input_tensor, scaling_factor_beta=100, dtype=torch.float32):
...
def soft_argmax1d(input_tensor, scaling_factor_beta=100, dtype=torch.float32):
